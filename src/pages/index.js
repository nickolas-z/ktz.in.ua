    	...
    	<div className="container">
    		<form action="" className="orderform">
    			...
    			<div className="orderform--select">
    				<select name="" id="">
    					<option value="Монтаж кабеля в грунт">Монтаж кабеля в грунт</option>
    					<option value="Монтаж пластикової труби в грунт (діаметр до 40 мм)">Монтаж пластикової труби в грунт (діаметр до 40 мм)</option>
    				</select>
    			</div>
    			<div className="orderform--date">
    				<div className="orderform--date__from">
    					<input type="text" placeholder="Від (дд.мм.рррр)" />
    				</div>
    				<div className="orderform--date__to">
    					<input type="text" placeholder="До (дд.мм.рррр)"/>
    				</div>
    			</div>
